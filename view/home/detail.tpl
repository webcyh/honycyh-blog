...
<link rel="stylesheet" href="/static/owo/dist/OwO.min.css">
<style type="text/css">
</style>
                  ...
                  <ul>
                    <li>
                      <div class="avater">
                        ...
                        <a class="bth-reply" data-id="1" data-name="webcyh" data-level="1" data-replyId="1" data-toele="#Id1">回复</a>
                    </li> 
